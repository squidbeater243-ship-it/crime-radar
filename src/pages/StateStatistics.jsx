...
// bundle for this page focused on what actually needs to paint first.
...
export default function StateStatistics() {
  usePageMeta({
    ...
    description: 'Search or browse verified crime, arrest, and poverty statistics for any U.S. state on an interactive map.',
      ...
      <main className="relative mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-6 py-16 sm:px-8 lg:px-10">
        ...
        >
          ...
          <div className="relative z-10">
            <p className="mb-3 text-sm uppercase tracking-[0.35em] text-cyan-300/80">State Statistics</p>
