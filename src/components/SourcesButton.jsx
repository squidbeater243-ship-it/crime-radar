  ...
  return (
    <>
      <button
        ...
        className="fixed right-5 bottom-5 z-50 inline-flex items-center gap-2 rounded-full bg-slate-900/80 px-3 py-2 text-xs font-medium text-slate-100 shadow-lg backdrop-blur transition hover:bg-slate-900/95"
      >
        Sources
      </button>
